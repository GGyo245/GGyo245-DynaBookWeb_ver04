...
public class FileService {
	 ...
	 * @return 저장된 파일명
	 */
	public static String saveFile(MultipartFile mfile, int key , String uploadPath) {
		...
		//저장 폴더가 없으면 생성
		File path = new File(uploadPath); // 먼저 자바상에서 가상으로 생성
		if (!path.isDirectory()) { // 실제 HDD 에서 확인
			path.mkdirs();
		}
		...
		//저장할 파일명
		String savedFilename = String.valueOf(key); 
