...
public class JsonReader {
	public static String callURL(String keyword) {
		
		
		String key = ""; //your unsplashAPI key
	    String myURL = "https://api.unsplash.com/search/photos/?client_id="+key+"&query="+keyword;
