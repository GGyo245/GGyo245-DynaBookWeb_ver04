...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/myWrite.css'/>">
</head>
    ...
    <div class="container-fluid" id="secondlayout">
        <div class="container-xl container-fluid">
            <div class="row" id="whiterow">
                ...
                <div class="col-lg-1 col-3 navi2"><a href="/user/myWriteBook" style="color : #1F8CE6;"ㅠ>글쓰기</a></div>
	...
	<div class="container-xl container-fluid">
         ...
         <div class="row" id="sidenavi">
            <div id="mysidenav" class="sidenav">
				...
				<a href="#" style="color:#1F8CE6;">소설 쓰기</a>
							...
							<c:forEach items="${book}" var="book">
								<div class="col-4 contents">
									<div class="contentsBoard">
										...
										<div class="mylistTitle">${book.title}</div>
									</div>
								</div>
							</c:forEach>
						</c:when>
						<c:otherwise>
							<div id="notFound">등록 된 소설이 없습니다.</div>
						</c:otherwise>
					</c:choose>
					<div class="col-12 page">
					  <button class="fun-btn" id="writeNovelBtn">소설 등록하기</button>
					</div>
				</div>	
			</div>
		<!-- /본문 끝 -->	
