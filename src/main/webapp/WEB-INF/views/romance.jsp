...
<body>
    ...
    <div class="container-fluid" id="secondlayout">
        <div class="container-xl container-fluid">
            <div class="row" id="whiterow">
                ...
                <div class="col-lg-1 col-3 navi2"><a href="/genre">일반</a></div>
                <div class="col-lg-1 col-3 navi2"><a href="#" style="color : #1F8CE6;">로맨스</a></div>
	...
	<div id="slide2back">
		<div class="category">
			<div id="categoryText1">로맨스, 추천리스트</div>
		</div>
	...
	<!-- 북 리스트 타입 -->
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		<div class="col-12" id="listCategory">신작 로맨스소설</div>
			<c:forEach items="${newBook}" var="book" varStatus="status" begin="0" end="8">
				<c:choose>
	...
	<div id="slide3back">
		<div class="category">
			<div id="categoryText2">인기소설 추천</div>
		</div>
		<div class="your-class">
	        <c:forEach items="${newBook}" var="book">
				<c:if test="${book.subtitle != null}">
	 ...
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		...
    		<c:forEach items="${newBook}" var="book" varStatus="status" begin="9" end="17">
				<c:choose>
					<c:when test="${status.last}">
						<div class="col-lg-4 col-6 listTitlecol" id="LastListTitle">
							<a href="/books?booknumber=${book.booknumber}">
