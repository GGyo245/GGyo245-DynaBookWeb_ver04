...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/resources/css/uploadNovel.css">
    ...
    <script type="text/javascript">
		...
		$(document).ready(function() {
				...
				$('#cancleBtn').on('click',function(){
					...
					var booknumber = queryString.split("=");
					
					window.location.href='books?booknumber='+booknumber[1]+'';
				});
	...
	<div class="container-fluid writeformBackground">
		<div class="container-xl container-fluid">
			<div class="row writeformRow">
				<div class="col-12">
					<div class="uploadNovelTitle">${book.title}</div>
				</div>
				...
				<form action="/insertDynaBookpart" method="post" id="insertDynaBookpart" autocomplete="off" onsubmit="return submitCK()">
					<div class="borderbottom">
					<table class="col-12 episodetable">
						<tr>
							<td>
								<!-- 에피소드 제목 -->
								<input class="inputEpisodeTitle" name="episodetitle" type="text" placeholder="에피소드 제목">
							</td>
							<td>
								<!-- 회차 번호 -->
								<input class="inputEpisodeNum" name="episode" type="text" placeholder="회차" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
							</td>
						</tr>
					</table>
					</div>
					...
					<div class="col-12 borderbottom">
						<div class="setPriceArea"> 회차별 가격을 입력해주세요. 
								<input class="setPrice" name="price" value="0" type="text" placeholder="0" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"> 원
						</div>
					</div>
					...
					<div class="col-12 borderbottom writeContext">
						...
						<textarea class="contextEpisode" id='summernote' name="text" rows="15" cols="55" placeholder="내용을 입력하세요"></textarea>
					</div>
					<!-- 작가의 말 DB 추가 필요 -->
					<div class="col-12 borderbottom">
						<textarea class="writerComment" id="writerComment" name="writercomment" rows="7" cols="55" placeholder="작가의 말"></textarea>
					</div>
					<input type="hidden" name="part_booknumber" value="${book.booknumber}">
					<!-- 취소버튼 누를 경우 뒤로 이동하도록 처리 필요 -->
