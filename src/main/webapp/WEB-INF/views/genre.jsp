...
<body>
    <div class="container-fluid" id="mainlayout">
        <div class="container-xl container-fluid">
            ...
            <div class="row" id="secondRow">
                ...
                <div class="col-lg-1 col-3 navi1">
                    <a href="#"><span class="css-nih33d-labelStyle">장르</span></a>
                </div>
    ...
    <div class="container-fluid" id="secondlayout">
        <div class="container-xl container-fluid">
            <div class="row" id="whiterow">
                ...
                <div class="col-lg-1 col-3 navi2" id="thisNavi2Page"><a href="#" style="color : #1F8CE6;">일반</a></div>
                <div class="col-lg-1 col-3 navi2"><a href="/romance">로맨스</a></div>
                <div class="col-lg-1 col-3 navi2"><a href="/fantagy">판타지</a></div>
                <div class="col-lg-1 col-3 navi2"><a href="/thriller">스릴러</a></div>
            </div>
        </div>
    </div>
	...
	<div id="slide2back">
		<div class="category">
			<div id="categoryText1">스릴러, 신작추천</div>
		</div>
		<div class="your-class">
			<c:forEach items="${thriller}" var="book">
	...
	<!-- 북 리스트 타입 -->
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		<div class="col-12" id="listCategory">신작 판타지소설</div>
			<c:forEach items="${fantagy}" var="book" varStatus="status" begin="0" end="8">
				<c:choose>
	...
	<div id="slide3back">
		<div class="category">
			<div id="categoryText2">판타지 신작리스트</div>
		</div>
		<div class="your-class">
	        <c:forEach items="${fantagy}" var="book">
				<c:if test="${book.subtitle != null}">
					<div>
						<a href="/books?booknumber=${book.booknumber}">
							<img class="slidetitleimg" src="<c:url value='/resources/css/img/TitleImg/${book.booknumber}.jpg'/>">
	...
	<div id="slide3back">
	 ...
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		<div class="col-12" id="listCategory">스릴러 신작리스트</div>
    		<c:forEach items="${thriller}" var="book" varStatus="status" begin="9" end="17">
				<c:choose>
					<c:when test="${status.last}">
						<div class="col-lg-4 col-6 listTitlecol" id="LastListTitle">
							<a href="/books?booknumber=${book.booknumber}">
