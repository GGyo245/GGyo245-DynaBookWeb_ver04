...
<body>
	...
	<div class="container-fluid writeformBackground">
		<div class="container-xl container-fluid">
			...
			<div class="col-12">
				<div class="uploadNovelTitle"> 작품 정보 수정 </div>
			</div>
		...
		<form action="/updateDynabook" method="post" id="updateDynabook" autocomplete="off" enctype="multipart/form-data" onsubmit='return uploadCheck();'>
			<!-- 북넘버 -->
			<input type="hidden" name="booknumber" value="${book.booknumber}">
			<!-- 제목 -->
			<div class="col-12 borderbottom">
				<input class="inputTitle" name="title" type="text" value="${book.title }">
			</div>
			<!-- 필명 -->
			<div class="col-12 borderbottom">
					<input id="penName" name="penname" type="text" value="${book.penname }">
			</div>
			<!-- 장르 -->
			<!-- select 값 넘겨주기 위한 처리 필요 -->
			<div class="col-12 borderbottom selectgenreArea">
				<div id="genreRow" class="selectGenreTitle"> 장르 </div>
				<select class="genreSelect" id="genreSelect" name="genre">
			...
			<div class="col-12 borderbottom">
				...
				<textarea id="summernote" name="introduce" rows="15" cols="55">
					${book.introduce}
				</textarea>
			</div>
			<!-- 표지 이미지 샘플 -> 수정 -->
			<div class="col-12 borderbottom">
				<div class="coverImage">
					표지 이미지 수정 (등록하지 않을 시 기존 이미지로 유지됩니다)
					<div id="fileupload">
