...
<body>
    <div class="container-fluid" id="mainlayout">
        <div class="container-xl container-fluid">
            ...
            <div class="row" id="secondRow">
                ...
                <div class="col-lg-1 col-3 navi1">
                    <a href="#"><span class="css-nih33d-labelStyle">인기</span></a>
                </div>
                <div class="col-lg-1 col-3 navi1">
    ...
    <div class="container-fluid" id="secondlayout">
        <div class="container-xl container-fluid">
            <div class="row" id="whiterow">
                ...
                <div class="col-lg-1 col-3 navi2"><a href="#" style="color : #1F8CE6;">인기 홈</a></div>
	...
	<div id="slide2back">
		<div class="category">
			<div id="categoryText1">판타지, 인기 추천</div>
		</div>
	...
	<!-- 북 리스트 타입 -->
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		<div class="col-12" id="listCategory">인기 스릴러소설</div>
	...
	<div id="slide3back">
		<div class="category">
			<div id="categoryText2">로맨스인기 추천</div>
		</div>
		<div class="your-class">
	 ...
	 <div class="container-xl container-fluid ListContainer">
    	<div class="row" id="listTitleRow">
    		<div class="col-12" id="listCategory">판타지소설 인기리스트</div>
